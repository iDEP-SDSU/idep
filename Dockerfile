...
RUN R -e 'install.packages(c("htmlwidgets","shiny", "shinyAce", "shinyBS", "plotly","RSQLite", "gplots", "ggplot2", "dplyr", "tidyverse","plotly","e1071", "reshape2", "DT","data.table", "Rcpp","flashClust","statmod","biclust","igraph","Rtsne"))' 
