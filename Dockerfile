...
RUN R -e 'install.packages(c("dendextend", "htmlwidgets","shiny", "shinyAce", "shinyBS", "plotly","RSQLite", "gplots", "ggplot2", "dplyr", "tidyverse","plotly","e1071", "reshape2", "DT","data.table", "Rcpp","flashClust","statmod","biclust","igraph","Rtsne","grid","gridExtra"))'
RUN R -e 'source("https://bioconductor.org/biocLite.R"); biocLite(c("STRINGdb", "limma", "DESeq2", "edgeR", "gage", "PGSEA", "fgsea", "ReactomePA", "pathview", "PREDA", "impute", "runibic","QUBIC","rhdf5", "PREDAsampledata", "sfsmisc", "lokern", "multtest", "GSEABase","hgu133plus2.db", "org.Ag.eg.db","org.At.tair.db","org.Bt.eg.db","org.Ce.eg.db","org.Cf.eg.db", "org.Dm.eg.db","org.Dr.eg.db","org.EcK12.eg.db","org.EcSakai.eg.db","org.Gg.eg.db","org.Hs.eg.db","org.Hs.ipi.db","org.Mm.eg.db","org.Mmu.eg.db","org.Pf.plasmo.db","org.Pt.eg.db","org.Rn.eg.db","org.Sc.sgd.db","org.Sco.eg.db","org.Ss.eg.db","org.Tgondii.eg.db","org.Xl.eg.db"), suppressUpdates = T)'
