...
4. Download the most recent database file from [here](http://18.235.92.206:8080/). Unzip it to the same folder (C:/IDEP), so that your database can be found at C:/IDEP/data/data104. 
