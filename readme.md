# iDEP and ShinyGO:   Intuitive, graphical tools for analyzing genomics data.  Let the data speak for itself!
...
4. Download the most recent database file from [here](http://18.235.92.206:8080/). Unzip all files to a folder (C:/IDEP/data/data104), so that your database can be found by the most recent versions of iDEP and ShinyGO. 
