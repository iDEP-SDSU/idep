  ...
  # Main Panel -------------------------------------
    mainPanel(  
     ...
     # ,a("Email",href="mailto:Xijin.Ge@SDSTATE.EDU?Subject=iDEP letter of support"), style = "color:red")
      ...
      ,h4("New 5/24/2020! Try out our new version 0.92 in testing mode. While the code is not changed, the new version is based on Ensembl release 100 with 392 species, updated annotaton, and many  manually collected pathways for 20 model organisms.", a("iDEP 0.92",href="http://bioinformatics.sdstate.edu/idep92/") )
