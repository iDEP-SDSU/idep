...
checkPackages <- function() {
  ...
  #auto install
  Rlibs = c("shiny","RSQLite","gplots","ggplot2","e1071","shinyAce","shinyBS",
            "reshape2","DT","plotly","statmod","biclust","WGCNA","Rtsne",
            "feather", "shinyjs", "reactable")
  ...
  bioLibs <- c( "limma", "DESeq2","edgeR","gage", "fgsea",
   "ReactomePA", "pathview","PREDA","PREDAsampledata","sfsmisc","lokern",
   "multtest","hgu133plus2.db","impute")
  
  if (Sys.info()["sysname"] != "Windows") {
    bioLibs <- c("org.Ag.eg.db","org.At.tair.db","org.Bt.eg.db","org.Ce.eg.db",
                 "org.Cf.eg.db","org.Dm.eg.db","org.Dr.eg.db","org.EcK12.eg.db",
                 "org.EcSakai.eg.db","org.Gg.eg.db","org.Hs.eg.db",
                 "org.Hs.ipi.db","org.Mm.eg.db","org.Mmu.eg.db",
                 "org.Pf.plasmo.db","org.Pt.eg.db","org.Rn.eg.db",
                 "org.Sc.sgd.db","org.Sco.eg.db","org.Ss.eg.db",
                 "org.Tgondii.eg.db","org.Xl.eg.db", bioLibs)
  }
  
  notInstalled <- setdiff(bioLibs, sysLib)
  if(length(notInstalled)>0) {
    if (!("PGSEA" %in% sysLib)) {
...
source('utility_functions.R') #load all utility functions
