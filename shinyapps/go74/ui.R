      ...
      tabsetPanel(
        tabPanel("Enrichment" 
                 ,conditionalPanel("input.goButton == 0 "  # welcome screen
                                   ,br()
                                   ,p("Nov. 15, 2021: Database update. ",a("ShinyGO v0.75", href="http://bioinformatics.sdstate.edu/go75/"), " released in testing mode. It includes Ensembl database update, new species from Ensembl Fungi and Ensembl Protists, and STRINGdb (5090 species) update to 11.5.", style = "color:red")
