...
#  fluidPage( 
  navbarPage("ITA",
    ...
    sidebarLayout(
      sidebarPanel(
	    #checkboxInput("CountsDataCheck", label = "RNA-seq raw counts data", value = FALSE),
	  ...
	  ,fileInput('file1', 'Choose file to upload',
	    ...
	    #checkboxInput("CountsDataCheck", label = "RNA-seq raw counts data", value = FALSE),
		# radioButtons("dataFileFormat", label = NULL, choices = list("RNA-seq raw counts data" = 1, "Normalized expression values(FPKM, microarray etc)" = 2),selected = 2)
    ...
    ,tabPanel("Pre-Process",
             sidebarLayout(
               sidebarPanel(
                 ...
                 radioButtons("transform", "Log Transformation",
                              c("No"=FALSE,"Yes"=TRUE) ),
