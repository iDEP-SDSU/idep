...
tableOutput('species' ),
		a(h5("?",align = "right"), href="https://idepsite.wordpress.com/data-format/")
...
a(" demo.", href="https://idepsite.wordpress.com/demo/"),
   "Based on annotation of",a( " 69 metazoa and 42 plant genomes ",href="https://idepsite.wordpress.com/species/") ,"in Ensembl BioMart as of 11/15/2016."
             ...
             sidebarLayout(
               sidebarPanel(
				...
				,actionButton("examineDataB", "Search processed data")
				 ...
				 ,br()
			,a(h5("?",align = "right"), href="https://idepsite.wordpress.com/pre-process/")
               ),
               mainPanel(
    ...
    ,tabPanel("Heatmap",
		 ...
		 ,br(),br(), h4("Mouse over to see gene names. To zoom, click and drag up or downward and relase.")
			,br(),a(h5("?",align = "right"), href="https://idepsite.wordpress.com/heatmap/")
					),
                mainPanel(				  
	...
	,tabPanel("k-Means",
			...
			,a(h5("?",align = "right"), href="https://idepsite.wordpress.com/k-means/")
				),
                mainPanel(
     ...
     ,tabPanel("PCA",
			...
			,br(),br()
			,a(h5("?",align = "right"), href="https://idepsite.wordpress.com/pca/")				
				),
                mainPanel(
                  plotOutput("PCA")
                )
	     ...
	     ,tabPanel("DEGs",
			...
			,a(h5("?",align = "right"), href="https://idepsite.wordpress.com/degs/")
				, width = 4),
   ...
   ,tabPanel("Pathways",
			...
			,a(h5("?",align = "right"), href="https://idepsite.wordpress.com/pathways/")		
				),
                mainPanel(	  
