  ...
  navbarPage("IEA",
   ...
   ,tabPanel("Pathways",
              sidebarLayout(
				...
				,selectInput("pathwayMethod", label = h5("Method for pathway analysis"), choices = list("GAGE" = 1, "PGSEA+ANOVA" = 2, "GSEA (preranked fgsea)" =3), selected = 1)
				...
				,numericInput("nPathwayShow", label = h5("Number of top pathway to show"), value = 40)
